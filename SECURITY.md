...
1. Go to the repository's **Security** tab → **Report a vulnerability**
   (https://github.com/DiamondsLab/hardhat-diamonds/security/advisories/new).
...
<https://github.com/DiamondsLab/hardhat-diamonds/issues> asking a maintainer to open a
